        ...
        <div className="text-center mb-16">
          <div className="flex justify-end mb-6">
            <button
              ...
              className="p-3 bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-all duration-300"
            >
              {isDarkMode ? (
