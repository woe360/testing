  ...
  const getOptionIcon = (optionIndex: number) => {
    if (showResults || (instantFeedback && selectedOption !== null)) {
      if (optionIndex === question.correctAnswer) {
        ...
        return (
          <div className="w-6 h-6 rounded-full bg-red-500 flex items-center justify-center mr-4 flex-shrink-0">
            <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
    ...
    return (
      <div className="w-6 h-6 rounded-full border-2 border-slate-300 dark:border-slate-500 flex items-center justify-center mr-4 flex-shrink-0 transition-colors duration-300">
    ...
    <div className="w-full max-w-4xl mx-auto">
      <div className="mb-8">        
        ...
        {((showResults || (instantFeedback && selectedOption !== null)) && !showResults) && (
          <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800 transition-colors duration-300">
            <h3 className="font-semibold text-blue-900 dark:text-blue-300 mb-2 transition-colors duration-300">Explanation:</h3>
            <p className="text-blue-800 dark:text-blue-200 transition-colors duration-300">{question.explanation}</p>
          </div>
        )}
