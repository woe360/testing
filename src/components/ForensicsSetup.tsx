...
import { getForensicsChapters } from '../utils/forensicsUtils'
import { forensicsQuestions } from '../data/forensicsQuestions'

interface ForensicsSetupProps {
  onStartQuiz: (
...
const ForensicsSetup: React.FC<ForensicsSetupProps> = ({ onStartQuiz, totalQuestions }) => {
  ...
  const chapters = getForensicsChapters(forensicsQuestions)
                ...
                {chapters.map((chapter) => (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm text-slate-500 dark:text-slate-400">({chapter.count} questions)</span>
                    </div>
                  </button>
                ))}
              </div>
