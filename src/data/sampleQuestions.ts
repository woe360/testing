...
export const sampleQuestions: QuizQuestion[] = [
  ...
  {
    id: '59',
    question: 'Which stage of the fundamental test process involves defining test completion criteria?',
    options: [
      "Test analysis and design",
      "Test planning and control",
      "Test implementation and execution",
    ...
    correctAnswer: 1,
    explanation: "Test completion criteria are defined during the planning stage."
  },
  {
    id: '60',
    question: 'Which provides the highest level of test independence?',
    options: [
      "Developer testing their own code",
      "Independent test team within the organization",
      "Outsourced testing to external company",
      "Business users testing the system"
    ],
    correctAnswer: 2,
    explanation: "External companies provide maximum independence from development bias."
  },
  {
    id: '61',
    question: 'For 100% decision coverage, how many test cases are needed for a single IF-THEN-ELSE statement?',
    options: [
      "1 test case",
      "2 test cases",
      "3 test cases",
    ...
    correctAnswer: 1,
    explanation: "One test for the TRUE branch and one for the FALSE branch."
  },
  {
    id: '62',
    question: 'In state transition testing, what triggers a change from one state to another?',
    options: [
      "A condition",
      "An event",
      "An action",
    ...
    correctAnswer: 1,
    explanation: "Events cause transitions between states in state transition diagrams."
  },
  {
    id: '63',
    question: 'When creating a test execution schedule, which tests should typically be run first?',
    options: [
      "The easiest tests to execute",
      "The longest tests to run",
      "The highest priority/risk tests",
      "The tests that require least data setup"
    ],
    correctAnswer: 2,
    explanation: "High priority tests should run first to find critical defects early."
  },
  {
    id: '64',
    question: 'What is the main purpose of configuration management in testing?',
    options: [
      "To manage test team schedules",
      "To control versions of test items and testware",
      "To configure test environments",
      "To manage test data"
    ],
    correctAnswer: 1,
    explanation: "Configuration management controls and tracks versions of all test-related items."
  },
  {
    id: '65',
    question: 'According to IEEE 1044, incident management includes all of the following EXCEPT:',
    options: [
      "Recognizing incidents",
      "Investigating incidents",
      "Preventing all future incidents",
      "Disposing of incidents"
    ],
    correctAnswer: 2,
    explanation: "Incident management handles existing incidents; prevention is a separate process improvement activity."
  },
  {
    id: '66',
    question: 'What is the main benefit of use case testing?',
    options: [
      "It tests individual components in isolation",
      "It provides high code coverage",
      "It tests realistic business scenarios and process flows",
      "It finds the most defects per test case"
    ],
    correctAnswer: 2,
    explanation: "Use case testing focuses on real user interactions and business processes."
  },
  {
    id: '67',
    question: 'Which of the following is an example of non-functional testing?',
    options: [
      "Testing if users can log into the system",
      "Testing if the system responds within 2 seconds",
      "Testing if orders can be placed successfully",
      "Testing if reports display correct data"
    ],
    correctAnswer: 1,
    explanation: "Performance (response time) is a non-functional requirement."
  },
  {
    id: '68',
    question: 'Which factor would trigger maintenance testing?',
    options: [
      "Adding new functionality to an existing system",
      "Starting a completely new project",
      "Planning future system requirements",
      "Training new team members"
    ],
    correctAnswer: 0,
    explanation: "Changes to existing systems require maintenance testing to ensure no regression occurs."
  },
  {
    id: '69',
    question: 'Which statement about test coverage is most accurate?',
    options: [
      "100% statement coverage guarantees the software is defect-free",
      "Test coverage measures the extent of testing performed",
      "Coverage can only be measured for code, not requirements",
      "Higher coverage always means better testing"
    ],
    correctAnswer: 1,
    explanation: "Coverage is a quantitative measure of what has been tested, not quality assurance."
  },
  {
    id: '70',
    question: 'For a field accepting ages 18-65, how many equivalence partitions exist?',
    options: [
      "2 partitions (valid and invalid)",
      "3 partitions (under 18, 18-65, over 65)",
      "4 partitions (including boundary values)",
      "5 partitions (including null values)"
    ],
    correctAnswer: 1,
    explanation: "One valid partition (18-65) and two invalid partitions (under 18, over 65)."
  },
  {
    id: '71',
    ...
    options: [
      ...
      "It reduces repetitive manual effort",
      "It improves test case design"
    ],
    correctAnswer: 2,
    explanation: "Automation's main benefit is reducing time spent on repetitive tasks."
  },
  {
    id: '72',
    question: 'What does bidirectional traceability enable?',
    options: [
      "Tests to be executed in both directions",
      "Requirements to link to tests and tests to link back to requirements",
      "Testing both positive and negative scenarios",
      "Forward and backward compatibility testing"
    ],
    correctAnswer: 1,
    explanation: "Bidirectional traceability allows tracking in both directions between requirements and tests."
  },
  {
    id: '73',
    question: 'Why should the test environment be as similar as possible to the production environment?',
    options: [
      "To reduce testing costs",
      "To speed up test execution",
      "To increase confidence that testing results are valid for production",
      "To simplify test data management"
    ],
    correctAnswer: 2,
    explanation: "Similar environments increase confidence that test results predict production behavior."
  },
  {
    id: '74',
    question: 'In which state would a defect be if it was fixed but not yet verified?',
    options: [
      "Open",
      "Fixed",
      "Closed",
    ...
    correctAnswer: 1,
    explanation: "Fixed state indicates the defect has been corrected but awaits verification testing."
  },
  {
    id: '75',
    question: 'Which approach would be most suitable for testing safety-critical software?',
    options: [
      "Exploratory testing",
      "Ad-hoc testing",
      "Standards-compliant approach with high coverage",
      "Risk-averse approach with minimal testing"
    ],
    correctAnswer: 2,
    explanation: "Safety-critical systems require rigorous, standards-based testing with high coverage."
  },
  {
    id: '76',
    question: 'What is the primary difference between load testing and stress testing?',
    options: [
      "Load testing is manual, stress testing is automated",
      "Load testing uses expected load, stress testing exceeds normal capacity",
      "Load testing tests functionality, stress testing tests performance",
      "Load testing is done early, stress testing is done late"
    ],
    correctAnswer: 1,
    explanation: "Load testing uses normal expected load, while stress testing pushes beyond normal limits."
  },
  {
    id: '77',
    question: 'What is the main risk of using production data for testing?',
    options: [
      "The data may be too large to process",
      "Confidential information may be exposed",
      "The tests may run too slowly",
      "The data may be too complex to understand"
    ],
    correctAnswer: 1,
    explanation: "Production data often contains sensitive information that must be protected."
  },
  {
    id: '78',
    question: 'Which is an example of a quantitative exit criterion?',
    options: [
      "All team members agree testing is complete",
      "The test manager is satisfied with quality",
      "95% of test cases have passed",
      "No critical issues remain open"
    ],
    correctAnswer: 2,
    explanation: "Specific percentages provide objective, measurable exit criteria."
  }
]